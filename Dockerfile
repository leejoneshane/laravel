...
RUN chmod 755 /usr/local/bin/*.sh \
    && apk update \
    && apk add --no-cache bash sudo git zip mc curl certbot acme-client openssl ca-certificates findutils \
                          mysql-client apache2 apache2-ssl python php7-apache2 php7-ldap php7-xmlwriter \
